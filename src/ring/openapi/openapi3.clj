...
(s/defn openapi-json
  ...
  ([openapi :- (s/maybe ring.openapi.full-schema/OpenApi)] (openapi-json openapi nil))
  ([openapi :- (s/maybe ring.openapi.full-schema/OpenApi), options :- (s/maybe swagger2/Options)]
